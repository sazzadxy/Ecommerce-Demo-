...
<div class="col-sm-4 col-lg-4 col-md-4">
    <div class="thumbnail">
        <a href="item.php?id={$row['product_id']}"><img style="height:200px" src="../resources/{$product_image}" alt="product image"></a>
        <div class="caption">
            <h4 class="pull-right">&#36;{$row['product_price']}</h4>
            <h4><a href="item.php?id={$row['product_id']}">{$row['product_title']}</a>
            </h4>
            <p>Click Details For Know More Options</p>
             <a class="btn btn-info" target="_blank" href="../resources/cart.php?add={$row['product_id']}">Add to cart</a>
             <a class="btn btn-light" target="_blank" href="item.php?id={$row['product_id']}">Details</a>
        </div>
            ...
            <div class="col-md-3 col-sm-6 hero-feature">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <p>
                            <a href="../resources/cart.php?add={$row['product_id']}" class="btn btn-info">Shop Now!</a> 
                            <a href="item.php?id={$row['product_id']}" class="btn btn-light">More Info</a>
                        </p>
                    </div>
                </div>
            </div>
...
$product = <<<DELIMETER
        ...
        <tr>
            ...
            <td>
             ...
             <a href="index.php?edit_product&id={$row['product_id']}"><p>{$row['product_title']}</p> <img width='150' src="../../resources/{$product_image}" alt="" class="responsive"></a>
...
echo "<p class='bg-danger'>This field cannot be blank</p>";
